...
export default function PhoneCaseDesignTable({
  title,
  subheader,
  tableLabels,
  tableData,
      ...
      <TableContainer sx={{ overflow: 'hidden', height: 460 }}>
        <Scrollbar>
          <Table sx={{ minWidth: 960 }}>
            ...
            <TableBody>
              {tableData.map((row) => (
                <PhoneCaseDesignTableRow key={row.id} row={row} />
              ))}
            </TableBody>
          </Table>
        </Scrollbar>
...
PhoneCaseDesignTable.propTypes = {
...
function PhoneCaseDesignTableRow({ row }) {
  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell style={{ maxWidth: 100 }}>Design Key</TableCell>

        <TableCell style={{ maxWidth: 100 }}>CODE</TableCell>

        <TableCell style={{ maxWidth: 100 }}>Item ID</TableCell>
...
PhoneCaseDesignTableRow.propTypes = {
